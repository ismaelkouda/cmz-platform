...
> **Généré automatiquement** par `tools/generate-status.mjs` le 2026-09-23.
...
| Fichiers TypeScript (`libs/`) | **2 729 fichiers hors tests** (2 979 au total, dont 250 specs) |
| Modules détectés | **19** |
...
| Corpus SEOS — couverture fichiers (N-4) | **918 / 2 729 fichiers libs/ hors tests → 33.6 %** — 1 modules sans aucune paire (1 `kernel`) |
...
| `core` | ✅ | kernel |  | 12 | Tokens d'injection + intercepteurs |
...
| `shared` | ✅ | kernel | application, browser, constants, data, domain, ui | 195 | Kernel transverse opérationnel |
