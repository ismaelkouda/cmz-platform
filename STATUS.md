...
| `dashboard`                     |   ✅   | read-only-view  | application, data, domain, ui                     |           29 | Module IR clôturé — corpus 25 paires, Meta 12/12 ; aggregated_stats_view           |
| `finalization`                  |   ✅   | workflow-action | application, data, domain, ui                     |          111 | Module IR clôturé — corpus 126 paires, 6 chaînes, Meta 12/12                       |
| `interactive-map`               |   ⚠️   | read-only-view  | application, data, domain, ui                     |           17 | IR partielle — visualization ✅, SIG hors scope ; corpus 28 paires, Meta documenté |
