...
import { AllFinalizationUseCase } from './all-finalization.use-case';

function makeEntity(uniqId: string): AllFinalizationEntity {
    return new AllFinalizationEntity({
...
describe('AllFinalizationUseCase', () => {
    ...
    it('execute delegates with page', async () => {
        const pageResult: PageResult<AllFinalizationEntity> = {
