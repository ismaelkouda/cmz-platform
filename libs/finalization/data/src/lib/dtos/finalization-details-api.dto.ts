...
export type FinalizationDetailsStatusApiDto =
    | 'pending'
    | 'approved'
    | 'rejected'
    | 'abandoned'
...
export type FinalizationDetailsFinalizationStateApiDto =
    'pending' | 'in-progress' | 'completed';

export interface FinalizationDetailsItemApiDto {
    uniq_id: string;
    ...
    status: FinalizationDetailsStatusApiDto;
    qualification_state: FinalizationDetailsFinalizationStateApiDto | null;
...
export type FinalizationDetailsResponseDto =
    SimpleResponseDto<FinalizationDetailsItemApiDto>;
