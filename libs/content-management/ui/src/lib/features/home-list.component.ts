...
import { HOME_TABLE } from '../constants/home-table.constant';
import { HOME_FORM } from '../constants/home-paths.constant';
...
export class HomeListComponent {
    ...
    private readonly store = inject(HomeFilterStore);
    ...
    protected readonly tableColumns = HOME_TABLE.cols;
    ...
    private readonly presenter = new HomePresenter((k) =>
        this.i18n.translate(k)
    );

    protected readonly itemsVM = computed<HomeVmProps[]>(() => {
        const authorization = {
        ...
        const tooltip = {
            ...
            enable: this.t(T + '.TOOLTIP.NO_PERMISSION_ENABLE'),
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: HOME_FILTER_KEYS.SEARCH,
            label: T + '.FILTER.SEARCH',
            placeholder: T + '.FILTER.SEARCH_PLACEHOLDER',
        },
        {
            type: 'select',
            name: HOME_FILTER_KEYS.STATUS,
            label: T + '.FILTER.STATUS',
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
            options: labelsToFilterOptions(HOME_STATUS_LABEL, (k) =>
                this.i18n.translate(k)
            ),
        },
        {
            type: 'date',
            name: HOME_FILTER_KEYS.START_DATE,
            label: T + '.FILTER.DATE.FROM',
        },
        {
            type: 'date',
            name: HOME_FILTER_KEYS.END_DATE,
    ...
    protected onAction(event: { row: HomeVmProps; actionId: string }): void {
    ...
    private navigateToForm(
        ...
        void this.router.navigate(['../', HOME_FORM], {
