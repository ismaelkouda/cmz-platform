...
export class SlideListComponent {
    ...
    protected readonly tableColumns = SLIDE_TABLE.cols;
    ...
    private readonly presenter = new SlidePresenter((k) =>
        this.i18n.translate(k)
    );

    protected readonly itemsVM = computed<SlideVmProps[]>(() => {
        const authorization = {
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: SLIDE_FILTER_KEYS.SEARCH,
            label: T + '.FILTER.SEARCH',
            placeholder: T + '.FILTER.SEARCH_PLACEHOLDER',
        },
        {
            type: 'select',
            name: SLIDE_FILTER_KEYS.STATUS,
            label: T + '.FILTER.STATUS',
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
            options: labelsToFilterOptions(SLIDE_STATUS_LABEL, (k) =>
                this.i18n.translate(k)
            ),
        },
        {
            type: 'date',
            name: SLIDE_FILTER_KEYS.START_DATE,
            label: T + '.FILTER.DATE.FROM',
        },
        {
            type: 'date',
            name: SLIDE_FILTER_KEYS.END_DATE,
    ...
    protected onAction(event: { row: SlideVmProps; actionId: string }): void {
    ...
    private navigateToForm(
        ...
        void this.router.navigate(['../', SLIDE_FORM], {
