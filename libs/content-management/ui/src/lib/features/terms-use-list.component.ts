...
import { TERMS_USE_TABLE } from '../constants/terms-use-table.constant';
import { TERMS_USE_FORM } from '../constants/terms-use-paths.constant';
...
export class TermsUseListComponent {
    protected readonly facade = inject(TermsUseFacade);
    private readonly store = inject(TermsUseFilterStore);
    ...
    protected readonly tableColumns = TERMS_USE_TABLE.cols;
    ...
    private readonly presenter = new TermsUsePresenter((k) =>
        this.i18n.translate(k)
    );

    protected readonly itemsVM = computed<TermsUseVmProps[]>(() => {
        const authorization = {
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: TERMS_USE_FILTER_KEYS.SEARCH,
            label: T + '.FILTER.SEARCH',
            placeholder: T + '.FILTER.SEARCH_PLACEHOLDER',
        },
        {
            type: 'text',
            name: TERMS_USE_FILTER_KEYS.VERSION,
            label: T + '.FILTER.VERSION',
        },
        {
            type: 'select',
            name: TERMS_USE_FILTER_KEYS.STATUS,
            label: T + '.FILTER.STATUS',
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
            options: labelsToFilterOptions(TERMS_USE_STATUS_LABEL, (k) =>
                this.i18n.translate(k)
            ),
        },
        {
            type: 'date',
            name: TERMS_USE_FILTER_KEYS.START_DATE,
            label: T + '.FILTER.DATE.FROM',
        },
        {
            type: 'date',
            name: TERMS_USE_FILTER_KEYS.END_DATE,
    ...
    private navigateToForm(
        ...
        void this.router.navigate(['../', TERMS_USE_FORM], {
