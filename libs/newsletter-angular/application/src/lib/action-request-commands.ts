...
} from '@cmz/newsletter-angular-domain';

// autoProvided:false — dépend de ACTION_REQUEST_PORT, un jeton sans valeur
// par défaut fourni par le composition root (app.config.ts) via useExisting
// vers ActionRequestClient (@cmz/newsletter-angular-data). application ne
// dépend jamais directement de data (ADR-0003 §4) — voir action-request-port.token.ts.
