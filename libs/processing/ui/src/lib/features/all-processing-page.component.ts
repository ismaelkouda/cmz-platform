...
import { AllProcessingVmProps } from '../adapters/all-processing-vm-props.interface';
import { AllProcessingPresenter } from '../adapters/all-processing-vm.presenter';
import { ALL_PROCESSING_FILTER_KEYS } from '../constants/all-processing-filter-keys.constant';
import { ALL_PROCESSING_TABLE } from '../constants/all-processing-table.constant';
import { PROCESSING_ALL_ROUTE } from '../constants/processing-paths.constant';
import { PROCESSING_ALL_STATE_OPTIONS } from '../constants/processing-all-state-label.constant';
import { AllProcessingFilterStore } from '../stores/all-processing-filter.store';
import {
...
@Component({
    selector: 'cmz-all-processing-page',
    imports: [
        FilterComponent,
        TableComponent,
        PaginationComponent,
    ...
    providers: [AllProcessingFilterStore],
    template: `
...
export class AllProcessingPageComponent {
    protected readonly facade = inject(AllProcessingFacade);
    ...
    protected readonly tableColumns = ALL_PROCESSING_TABLE.cols;
    protected readonly tableActions = ALL_PROCESSING_TABLE.actions;
    ...
    private readonly presenter = new AllProcessingPresenter((key) =>
        this.i18n.translate(key)
    );

    protected readonly itemsVM = computed<AllProcessingVmProps[]>(() =>
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: ALL_PROCESSING_FILTER_KEYS.INITIATOR_PHONE_NUMBER,
            label: `${T}.FILTER.INITIATOR`,
            placeholder: 'COMMON.PHONE_PLACEHOLDER',
        },
        {
            type: 'text',
            name: ALL_PROCESSING_FILTER_KEYS.UNIQ_ID,
            label: `${T}.FILTER.UNIQ_ID`,
            placeholder: 'COMMON.REPORT_UNIQ_ID_PLACEHOLDER',
        },
        {
            type: 'select',
            name: ALL_PROCESSING_FILTER_KEYS.REPORT_TYPE,
        ...
        {
            type: 'text',
            name: ALL_PROCESSING_FILTER_KEYS.OPERATORS,
            label: `${T}.FILTER.OPERATORS`,
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
        },
        {
            type: 'select',
            name: ALL_PROCESSING_FILTER_KEYS.SOURCE,
        ...
        {
            type: 'select',
            name: ALL_PROCESSING_FILTER_KEYS.STATE,
            label: `${T}.FILTER.STATE`,
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
            options: PROCESSING_ALL_STATE_OPTIONS,
        },
        {
            type: 'date',
            name: ALL_PROCESSING_FILTER_KEYS.START_DATE,
            label: 'COMMON.START_DATE',
        },
        {
            type: 'date',
            name: ALL_PROCESSING_FILTER_KEYS.END_DATE,
