...
import { QueuesProcessingVmProps } from '../adapters/queues-processing-vm-props.interface';
import { QueuesProcessingPresenter } from '../adapters/queues-processing-vm.presenter';
import { QUEUES_PROCESSING_FILTER_KEYS } from '../constants/queues-processing-filter-keys.constant';
import { PROCESSING_QUEUES_ROUTE } from '../constants/processing-paths.constant';
import { QUEUES_PROCESSING_TABLE } from '../constants/queues-processing-table.constant';
import { QueuesProcessingFilterStore } from '../stores/queues-processing-filter.store';
import {
...
@Component({
    selector: 'cmz-queues-processing-page',
    imports: [
        FilterComponent,
        TableComponent,
        PaginationComponent,
    ...
    providers: [QueuesProcessingFilterStore],
    template: `
...
export class QueuesProcessingPageComponent {
    ...
    protected readonly tableColumns = QUEUES_PROCESSING_TABLE.cols;
    protected readonly tableActions = QUEUES_PROCESSING_TABLE.actions;
    ...
    private readonly presenter = new QueuesProcessingPresenter((key) =>
        this.i18n.translate(key)
    );

    protected readonly itemsVM = computed<QueuesProcessingVmProps[]>(() =>
        this.facade
            .items()
            .map((item) =>
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: QUEUES_PROCESSING_FILTER_KEYS.INITIATOR_PHONE_NUMBER,
            label: `${T}.FILTER.INITIATOR`,
            placeholder: 'COMMON.PHONE_PLACEHOLDER',
        },
        {
            type: 'text',
            name: QUEUES_PROCESSING_FILTER_KEYS.UNIQ_ID,
            label: `${T}.FILTER.UNIQ_ID`,
            placeholder: 'COMMON.REPORT_UNIQ_ID_PLACEHOLDER',
        },
        {
            type: 'select',
            name: QUEUES_PROCESSING_FILTER_KEYS.REPORT_TYPE,
        ...
        {
            type: 'text',
            name: QUEUES_PROCESSING_FILTER_KEYS.OPERATORS,
            label: `${T}.FILTER.OPERATORS`,
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
        },
        {
            type: 'select',
            name: QUEUES_PROCESSING_FILTER_KEYS.SOURCE,
        ...
        {
            type: 'date',
            name: QUEUES_PROCESSING_FILTER_KEYS.START_DATE,
            label: 'COMMON.START_DATE',
        },
        {
            type: 'date',
            name: QUEUES_PROCESSING_FILTER_KEYS.END_DATE,
