...
import { DepartmentFacade } from '@cmz/administrative-boundary-application';
import { TranslationPort } from '@cmz/shared-application';
import { FieldComponent } from '@cmz/shared-ui';
import { DepartmentFormStore } from '../stores/department-form.store';
import { FormMode } from '../stores/form-mode.type';

const T = 'ADMINISTRATIVE_BOUNDARY.DEPARTMENT';

@Component({
    selector: 'cmz-department-form',
    standalone: true,
    changeDetection: ChangeDetectionStrategy.OnPush,
    imports: [FormField, FieldComponent],
    providers: [DepartmentFormStore],
    template: `
...
export class DepartmentFormComponent {
    protected readonly store = inject(DepartmentFormStore);
