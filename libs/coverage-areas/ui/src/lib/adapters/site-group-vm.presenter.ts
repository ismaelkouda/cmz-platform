...
const T = 'COVERAGE_AREAS.SITE_GROUP.TOOLTIP';

/**
 * Presenter (UI) : `SiteGroupEntity` → view-model. `statusStyle` et
...
export class SiteGroupPresenter {
    ...
    map(
        ...
        permission: SiteGroupPermission
    ): SiteGroupVmProps {
