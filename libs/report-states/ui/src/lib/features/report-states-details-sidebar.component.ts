...
export class ReportStatesDetailsSidebarComponent {
    ...
    protected showApproverSection(item: ReportStatesDetailsEntity): boolean {
        return !!(item.treater.approvedAt || item.approvedBy);
    }

    protected showRejecterSection(item: ReportStatesDetailsEntity): boolean {
