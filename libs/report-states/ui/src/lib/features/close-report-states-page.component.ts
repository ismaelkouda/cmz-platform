...
import { CloseReportStatesVmProps } from '../adapters/close-report-states-vm-props.interface';
import { CloseReportStatesPresenter } from '../adapters/close-report-states-vm.presenter';
import { CLOSE_REPORT_STATES_FILTER_KEYS } from '../constants/close-report-states-filter-keys.constant';
import { CLOSE_REPORT_STATES_TABLE } from '../constants/close-report-states-table.constant';
import { REPORT_STATES_CLOSE_ROUTE } from '../constants/report-states-paths.constant';
import { CloseReportStatesFilterStore } from '../stores/close-report-states-filter.store';
import {
...
@Component({
    selector: 'cmz-close-report-states-page',
    imports: [
        FilterComponent,
        TableComponent,
        PaginationComponent,
    ...
    providers: [CloseReportStatesFilterStore],
    template: `
...
export class CloseReportStatesPageComponent {
    ...
    protected readonly tableColumns = CLOSE_REPORT_STATES_TABLE.cols;
    protected readonly tableActions = CLOSE_REPORT_STATES_TABLE.actions;
    ...
    private readonly presenter = new CloseReportStatesPresenter((key) =>
        this.i18n.translate(key)
    );

    protected readonly itemsVM = computed<CloseReportStatesVmProps[]>(() =>
    ...
    protected readonly filterFields: Signal<FilterField[]> = computed(() => [
        {
            type: 'text',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.INITIATOR_PHONE_NUMBER,
            label: `${T}.FILTER.INITIATOR`,
            placeholder: 'COMMON.PHONE_PLACEHOLDER',
        },
        {
            type: 'text',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.UNIQ_ID,
            label: `${T}.FILTER.UNIQ_ID`,
            placeholder: 'COMMON.REPORT_UNIQ_ID_PLACEHOLDER',
        },
        {
            type: 'select',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.REPORT_TYPE,
        ...
        {
            type: 'text',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.OPERATORS,
            label: `${T}.FILTER.OPERATORS`,
            placeholder: 'COMMON.SELECT_PLACEHOLDER',
        },
        {
            type: 'select',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.SOURCE,
        ...
        {
            type: 'date',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.START_DATE,
            label: 'COMMON.START_DATE',
        },
        {
            type: 'date',
            name: CLOSE_REPORT_STATES_FILTER_KEYS.END_DATE,
