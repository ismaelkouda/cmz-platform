...
import { EvaluateFacade } from '@cmz/report-states-application';

@Component({
    selector: 'cmz-evaluate-page',
    standalone: true,
    ...
    template: `
        ...
        >
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-1">
                        Historique des signalements ayant fait l'objet d'une
                        évaluation.
                    </p>
                </div>
                <button
            ...
            @if (facade.isLoading()) {
                ...
                >
                    Chargement des signalements évalués…
                </div>
            } @else if (hasError()) {
                <div
