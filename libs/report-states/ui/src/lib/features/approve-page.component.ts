...
import { ApproveFacade } from '@cmz/report-states-application';

@Component({
    selector: 'cmz-approve-page',
    standalone: true,
    ...
    template: `
        ...
        >
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-xl font-bold text-slate-100">
                        Demandes Recevables (Approuvées)
                    </h2>
            ...
            @if (facade.isLoading()) {
                ...
                >
                    Chargement des signalements recevables…
                </div>
            } @else if (hasError()) {
                <div
