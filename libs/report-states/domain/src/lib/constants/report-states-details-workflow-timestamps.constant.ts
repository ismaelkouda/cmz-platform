...
export const REPORT_STATES_DETAILS_WORKFLOW_STEPS = [
    {
...
export type ReportStatesDetailsWorkflowStepKey =
    (typeof REPORT_STATES_DETAILS_WORKFLOW_STEPS)[number]['key'];

export type ReportStatesDetailsWorkflowStepKeyAlt = 'rejectedAt';
