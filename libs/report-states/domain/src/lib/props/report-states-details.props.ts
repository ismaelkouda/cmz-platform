...
export interface ReportStatesDetailsProps {
    ...
    readonly status: ReportStatesDetailsStatus;
    readonly qualificationState: ReportStatesDetailsQualificationState | null;
...
export interface ReportStatesDetailsPermissions {
    readonly canTake: boolean;
    readonly canQualify: boolean;
}

export interface ReportStatesDetailsContext {
    readonly props: ReportStatesDetailsProps;
    readonly permissions: ReportStatesDetailsPermissions;
}
