...
import type { EvaluateReportStatesProps } from '@cmz/report-states-domain';
import { TypeReport } from '@cmz/shared-domain';
import { EvaluateReportStatesItemApiDto } from '../dtos/evaluate-report-states-response-api.dto';

@Service()
export class EvaluateReportStatesItemMapper extends PaginatedMapper<
...
> {
    ...
    protected override mapItemFromDto(
        dto: EvaluateReportStatesItemApiDto
    ): EvaluateReportStatesEntity {
        MapperUtils.validateDto(dto, { required: ['uniq_id'] });
        const props: EvaluateReportStatesProps = {
        ...
        const entity = cached
            ? cached.with(props)
            : new EvaluateReportStatesEntity(props);
