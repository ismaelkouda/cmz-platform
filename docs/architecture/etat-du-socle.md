...
- **État :** **Phase 08** — génération depuis patterns ([ADR-0013](../adr/0013-phases-08-generation-et-09-verification.md)). Socle outillé + Kernel `shared/` / `@cmz/core` + **18** modules livrés/compilants (**71** libs + **1** app ; **2 561** `.ts` hors tests). Voir [`STATUS.md`](../../STATUS.md).
