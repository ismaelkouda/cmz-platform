...
- **Dernière mise à jour :** 2026-09-23 (généré par `tools/generate-status.mjs`)
- **État :** **Phase 08** — génération depuis patterns ([ADR-0013](../adr/0013-phases-08-generation-et-09-verification.md)). Socle outillé + Kernel `shared/` / `@cmz/core` + **19** modules livrés/compilants (**72** libs + **2** app ; **2 729** `.ts` hors tests). Voir [`STATUS.md`](../../STATUS.md).
