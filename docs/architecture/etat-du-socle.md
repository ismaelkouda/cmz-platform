...
- **Bundle initial (production, raw)** : **521.15 kB** — source [`bundle-metrics.json`](../../apps/backoffice-angular/bundle-metrics.json) (mesuré 2026-09-11 via `bun run bundle:record` après build).
