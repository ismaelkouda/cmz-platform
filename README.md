...
**État au 2026-08-30 :** Phase **08** (génération depuis patterns) — **21** modules, **77** libs + **1** app, **2 742** fichiers `.ts` hors tests. Bundle initial prod **526.38 kB**. Voir [`STATUS.md`](./STATUS.md).
