...
**État au 2026-08-11 :** Phase **08** (génération depuis patterns) — **19** modules, **72** libs + **1** app, **2 722** fichiers `.ts` hors tests. Bundle initial prod **872.78 kB**. Voir [`STATUS.md`](./STATUS.md).
