...
**État au 2026-08-27 :** Phase **08** (génération depuis patterns) — **20** modules, **74** libs + **3** app, **2 741** fichiers `.ts` hors tests. Bundle initial prod **629.01 kB**. Voir [`STATUS.md`](./STATUS.md).
