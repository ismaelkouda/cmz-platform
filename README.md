...
**État au 2026-09-08 :** Phase **08** (génération depuis patterns) — **19** modules, **72** libs + **1** app, **2 727** fichiers `.ts` hors tests. Bundle initial prod **526.38 kB**. Voir [`STATUS.md`](./STATUS.md).
