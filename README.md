...
**État au 2026-08-21 :** Phase **08** (génération depuis patterns) — **19** modules, **72** libs + **1** app, **2 730** fichiers `.ts` hors tests. Bundle initial prod **629.01 kB**. Voir [`STATUS.md`](./STATUS.md).
