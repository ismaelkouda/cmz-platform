...
**État au 2026-08-10 :** Phase **08** (génération depuis patterns) — **18** modules, **71** libs + **1** app, **2 724** fichiers `.ts` hors tests. Bundle initial prod **882.18 kB**. Voir [`STATUS.md`](./STATUS.md).
