...
**État au 2026-09-25 :** Phase **08** (génération depuis patterns) — **19** modules, **72** libs + **3** app, **2 730** fichiers `.ts` hors tests. Bundle initial prod **521.22 kB**. Voir [`STATUS.md`](./STATUS.md).
