...
**État au 2026-09-11 :** Phase **08** (génération depuis patterns) — **19** modules, **72** libs + **2** app, **2 727** fichiers `.ts` hors tests. Bundle initial prod **521.15 kB**. Voir [`STATUS.md`](./STATUS.md).
