...
const REQUESTS_LIST_POOL_SIZE = 1548;

function buildRequestsListItems(count = REQUESTS_LIST_POOL_SIZE) {
...
function filterRequestsListItems(items, searchParams) {
    let result = items;
...
async function handle(req, res, url) {
    ...
    const buildProcessingDetail = (uniqId) => ({
        id: uniqId,
        uniq_id: uniqId,
