...
| `check-semantics.mjs` + `check-semantics-lib.mjs` | Vérifie le **contenu** (9 règles mécaniques issues de bugs réels) — helpers dans `check-semantics-lib.mjs` (plafond 800 l.) |
