...
/**
 * Exceptions cross-module explicites et motivées, au cas par cas.
 * Périmètre strictement borné aux chemins listés ; toute autre
 * duplication cross-module reste bloquante.
 */
