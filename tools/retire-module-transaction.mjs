...
import { retirementPlanSha256 } from './module-lifecycle-plan.mjs';
import {
...
export const TRANSACTION_RELATIVE_ROOT = MODULE_LIFECYCLE_TRANSACTION_ROOT;
...
export function withTransactionLock(workspaceRoot, metadata, operation) {
    return withModuleLifecycleLock(workspaceRoot, metadata, operation);
}
