...
| Indicateur                | Valeur                                                                                                       |
| ------------------------- | ------------------------------------------------------------------------------------------------------------ |
| Dernière génération       | **2026-09-11** (`bun run generate:status`)                                                                      |
...
| Bundle initial (prod, raw)| **534.54 kB** ([`bundle-metrics.json`](./apps/backoffice-angular/bundle-metrics.json), 2026-09-11) |
