...
| Fichiers TypeScript       | **2 723** hors tests / **2 890** total (167 specs)                 |
...
| Corpus SEOS — couverture (N-4) | **930 / 2 723 fichiers libs/ hors tests → 34.2 %** — 1 modules sans aucune paire (1 `kernel`), absent sans ce chiffre (P0-12) |
