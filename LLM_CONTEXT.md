...
| Fichiers TypeScript       | **2 561** hors tests / **2 704** total (143 specs)                 |
...
| Corpus SEOS — couverture (N-4) | **476 / 2 561 fichiers libs/ hors tests → 18.6 %** — 9 modules sans aucune paire (7 `crud-entity`, 1 `action-request`, 1 `kernel`), absent sans ce chiffre (P0-12) |
