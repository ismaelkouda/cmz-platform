...
| Fichiers TypeScript       | **2 558** hors tests / **2 701** total (143 specs)                 |
...
| Corpus SEOS — couverture (N-4) | **476 / 2 558 fichiers libs/ hors tests → 18.6 %** — 9 modules sans aucune paire (7 `crud-entity`, 1 `action-request`, 1 `kernel`), absent sans ce chiffre (P0-12) |
